...
public class SimpleEmailSender extends Authenticator implements IEmailSender {
    ...
    public SimpleEmailSender() {
        this.host = SystemOptions.get(Consts.OPTION_CONNECTION_EMAIL_SMTP);
        this.name = SystemOptions.get(Consts.OPTION_CONNECTION_EMAIL_ACCOUNT);
        this.password = SystemOptions.get(Consts.OPTION_CONNECTION_EMAIL_PASSWORD);
        this.useSSL = SystemOptions.getAsBool(Consts.OPTION_CONNECTION_EMAIL_SSL_ENABLE);
        this.enable = SystemOptions.getAsBool(Consts.OPTION_CONNECTION_EMAIL_ENABLE);
    }
