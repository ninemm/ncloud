 ...
 *
 */
package net.ninemm.commons.sms;
...
public class AliyunSmsSender implements ISmsSender {
    ...
    public boolean send(SmsMessage sms) {
        ...
        String app_key = SystemOptions.get(Consts.OPTION_CONNECTION_SMS_APPID);
        String app_secret = SystemOptions.get(Consts.OPTION_CONNECTION_SMS_APPSECRET);
...
//        return new sun.misc.BASE64Encoder().encode(signData);
    ...
    public static void main(String[] args) {
        ...
        SystemOptions.set(Consts.OPTION_CONNECTION_SMS_APPID, app_key);
        SystemOptions.set(Consts.OPTION_CONNECTION_SMS_APPSECRET, app_secret);
